...
Add Post processing behaviour(script) into your camera and choose PostProcessingProfile.asset ImagyVFX folder
...
add moveablelinerenderer (trails with the turbulence)
add dynamic outline
